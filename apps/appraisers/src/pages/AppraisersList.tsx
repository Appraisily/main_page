...
export default function AppraisersList() {
  ...
  return (
    <>
      <SEO 
        title="Find an Art & Antique Appraiser | Browse Our Directory"
        description="Search our directory of qualified art and antique appraisers. Filter by specialty and location to find the perfect expert for your valuation needs."
      />
